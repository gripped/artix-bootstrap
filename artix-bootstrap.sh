...
PACMAN_PACKAGES=(
  acl artix-mirrorlist brotli bzip2 coreutils curl e2fsprogs expat gawk gettext glibc gnupg gpgme grep keyutils krb5 libarchive libassuan libgpg-error libidn2 libnghttp2 libnghttp3 libpsl libssh2 libunistring libxml2 lz4 openssl pacman xz zlib zstd
)
